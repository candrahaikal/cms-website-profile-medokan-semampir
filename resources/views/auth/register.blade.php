                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7 col">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Silakan melakukan registrasi akun baru.</p>
                                    </div>
                                </div>
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('register.post') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" placeholder="Masukkan nama" type="text"
                                            class="form-control form-control" aria-invalid="false">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input name="password" placeholder="Masukkan kata sandi" type="password"
                                                id="password-input" class="form-control" aria-invalid="false"
                                                value="">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <p><span class="fw-bold">© {{ date('Y') }} KKN NR-05 - Universitas 17 Agustus 1945
                                Surabaya.</span> <span class="text-secondary"><br> Made with <i
                                    class="mdi mdi-heart text-danger"></i> by Candra Haikal</span></p>
                    </div>
                </div>
            </div>
        </div>
