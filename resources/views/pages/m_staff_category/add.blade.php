...
@section('title', 'Tambah Data Kategori Jabatan | Medokan Semampir')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Tambah Data Kategori Jabatan</h4>

                <!-- begin breadcrumb -->
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Utama</a></li>
                        <li class="breadcrumb-item active">Tambah Data Kategori Jabatan</li>
                    </ol>
                </div>
                <!-- end breadcrumb -->
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{-- <div class="h4 card-title">Silakan tambahkan data Kategori Jabatan</div> --}}
                    ...
                    <form class="form" action="{{ route('staff-category.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center">Tambah Kategori Jabatan</button>
                            </div>
                        </div>
                    </form>
