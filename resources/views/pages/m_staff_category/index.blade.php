            ...
            <div class="card">
                <div class="card-body">
                    <p class="card-title-desc">
                        Berikut ini adalah tabel yang menunjukkan daftar Jenis Jabatan yang ada di Kelurahan Medokan
                        Semampir.
                    </p>
                        ...
                        <tbody>
                            @foreach ($mStaffCategories as $mStaffCategory)
                                <tr data-id="{{ $mStaffCategory->id }}">
                                    ...
                                    <td>
                                        <a href="{{ route('staff-category.edit', ['id' => $mStaffCategory->id]) }}"
                                            class="btn btn-success">Ubah</a>
                                        <form action="{{ route('staff-category.delete', ['id' => $mStaffCategory->id]) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('save-order').addEventListener('click', function(event) {
                ...
                const order = [...document.querySelectorAll('#sortable-table tbody tr')].map(row => row
                    .dataset.id);
                // console.log(order)
                ...
                fetch('/staff-category/update-order', {
                        method: 'POST',
                        headers: {
