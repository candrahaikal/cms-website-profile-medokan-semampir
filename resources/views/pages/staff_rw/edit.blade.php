...
@section('title', 'Ubah Data Pegawai RW ' . $rw_id. ' | Medokan Semampir')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Ubah Data Pegawai RW {{$rw_id}}</h4>

                <!-- begin breadcrumb -->
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Utama</a></li>
                        <li class="breadcrumb-item active">Ubah Data Pegawai RW {{$rw_id}}</li>
                    </ol>
                </div>
                <!-- end breadcrumb -->
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form" action="{{ route('staff-rw.update') }}" method="POST">
                        @csrf

                        <input type="hidden" name="id" value="{{ $staffRw->id }}">
                        <input type="hidden" name="rw_id" value="{{ $staffRw->rw_id }}">
                        ...
                        <div class="mb-3 row form-switch form-switch-md p-0" dir="ltr">
                            <label class="col-md-2 col-form-label" for="switch_staff_rw">Status</label>
                            <div class="col-md-10 d-flex gap-2 align-items-center">
                                <label class="d-inline-block me-5 mb-0 text-secondary">Tidak Aktif</label>
                                <input class="form-check-input" class="d-inline-block" type="checkbox" id="switch_staff_rw"
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center">Ubah Pegawai RW</button>
                            </div>
                        </div>
                    </form>
