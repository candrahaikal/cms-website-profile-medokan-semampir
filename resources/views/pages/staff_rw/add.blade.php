...
@section('title', 'Tambah Data Pegawai RW ' . $rw_id. ' | Medokan Semampir')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Tambah Data Pegawai RW {{$rw_id}}</h4>

                <!-- begin breadcrumb -->
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Utama</a></li>
                        <li class="breadcrumb-item active">Tambah Data Pegawai RW {{$rw_id}}</li>
                    </ol>
                </div>
                <!-- end breadcrumb -->
            </div>
                ...
                <div class="card-body">
                    ...
                    <form class="form" action="{{ route('staff-rw.store') }}" method="POST">
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center">Tambah Pegawai RW</button>
                            </div>
                        </div>
                    </form>
