                        ...
                        <tbody>
                            @foreach ($staffRws as $staffRw)
                                <tr>
                                    ...
                                    <td class="data-small">
                                        <a href="{{ route('staff-rw.edit', ['id'=>$staffRw->id]) }}" class="btn btn-success">Ubah</a>
                                        <form action="{{ route('staff-rw.delete', ['id'=>$staffRw->id, 'rw_id'=>$rw_id]) }}" method="POST" class="d-inline-block">
                                            @csrf
                                            @method('DELETE')
