...
class FacilityRwController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $facilities = FacilityRw::where('rw_id', $rw->id)->get();

        return view('pages.facility_rw.index', compact('facilities', 'rw'));
    }
    ...
    {
        $rw = MRw::find($request->rw);
        return view('pages.facility_rw.add', compact('rw'));
    }
     ...
     *
     * @param  \App\Models\FacilityRw  $facilityRw
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request)
    {
        $facility = FacilityRw::findOrFail($request->id);
        $rw = MRw::find($facility->rw_id);

        return view('pages.facility_rw.edit', compact('facility', 'rw'));
    }
    ...
    public function destroy(Request $request)
    {
        ...
        $facility = FacilityRw::find($request->id);
